...
export const metadata: Metadata = createMetadata({
  ...
  description: `Read the Terms of Service of ${COMPANY.name}. Understand the conditions governing your use of our website and loan facilitation services.`,
  path: "/terms",
});
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mb-10 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Last updated:{" "}
                {new Date(terms.lastUpdated).toLocaleDateString("en-IN", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                })}
          ...
          <div className="mt-12 border-t border-border/50 pt-6 text-xs text-muted-foreground">
            These Terms are governed by the laws of India. Any disputes shall be subject to the exclusive jurisdiction of courts in {COMPANY.address.city}, Tamil Nadu.
          </div>
